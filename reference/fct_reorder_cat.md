...
Wrapper al rededor de \`forcats::fct_reorder2\` para ordenar factor
\`.f\` según según una catogoría de respuesta de \`.x\` de interès
\`cat_orden\` a partir del valor en \`.y\`.
